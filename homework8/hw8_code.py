...
#-------------------------------------------------------------------------------
    ...
    def errorFunction( params ):
        ...
        values (which are the location of the corners of the pattern) and outputs the 
        an error.
        '''
        ...
        for i in range( iStart, len( params ), 6 ):
            ...
            error = np.mean( error )
            error = np.ones( len(params) ) * error
            #print(error.shape)
...
#-------------------------------------------------------------------------------
        ...
        rSq = (x - x0)**2 + (y - y0)**2
        xRad = x + (x - x0) * ( k1 * rSq**2 + k2 * rSq**4 )
        yRad = y + (y - y0) * ( k1 * rSq**2 + k2 * rSq**4 )
...
#-------------------------------------------------------------------------------
        ...
        rSq = (x - x0)**2 + (y - y0)**2
        xRad = x + (x - x0) * ( k1new * rSq**2 + k2new * rSq**4 )
        yRad = y + (y - y0) * ( k1new * rSq**2 + k2new * rSq**4 )
